...
xvfb-run -s "-screen 0 1280x720x24" ./visualize --policy-name pufferlib/resources/drive/models/apricot-voice-35/puffer_drive_weights.bin --map-name pufferlib/resources/drive/binaries/sanity/map_000.bin --log-traje
ctories --zoom-in --view topdown --output-topdown pufferlib/resources/drive/models/apricot-voice-35/videos/topdown_sanity000.mp4 --output-agent pufferlib/resources/drive/models/unyjnpvn/videos/sanity/agent.mp4
