...
LOG_DIR="$ROOT/experiments_ppo_ablation4096_queue_logs"
mkdir -p "$LOG_DIR"

WARMSTART_CKPT="experiments_warmstart_large/puffer_drive_177722345679/model_puffer_drive_000008.pt"

configs=(
  "pufferlib/config/ocean/drive_trajectory_ppo_finetune_ablation4096_conservative.ini"
  "pufferlib/config/ocean/drive_trajectory_ppo_finetune_ablation4096_std0125.ini"
  "pufferlib/config/ocean/drive_trajectory_ppo_finetune_ablation4096_lr1e4.ini"
)

tags=(
  "ppo_ablation4096_conservative_from_large_ckpt8"
  "ppo_ablation4096_std0125_from_large_ckpt8"
  "ppo_ablation4096_lr1e4_from_large_ckpt8"
)
